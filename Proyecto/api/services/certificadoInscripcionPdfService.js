...
/**
 * Genera un PDF de constancia de inscripción y lo envía por el stream de respuesta HTTP.
 * @param {object} inscripcion - Fila de inscripción (obtenerPorId)
 * @param {import('http').ServerResponse} res - Respuesta Express ya con headers Content-Type / Content-Disposition
 */
function pipeCertificadoInscripcionPdf(inscripcion, res) {
